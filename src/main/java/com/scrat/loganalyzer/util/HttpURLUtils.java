...
public final class HttpURLUtils {
	...
	private static HttpURLConnection sendPost(String reqUrl, Map<String, String> parameters) throws IOException {
		HttpURLConnection urlConn = null;
		String params = generatorParamString(parameters);
		URL url = new URL(reqUrl);
		urlConn = (HttpURLConnection) url.openConnection();
	...
	public static void main(String[] args) {
		...
		params.put("sessionId", "68137533680097827E7CB88661764DA1");
		String result = HttpURLUtils.doPost("https://account.host.com/api/isLogin", params);
